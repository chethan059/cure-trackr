    ...
    >
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <CardTitle className="text-xl font-bold">{diagnosis.disease}</CardTitle>
          <span 
            className={cn(
              "diagnosis-tag",
              getConfidenceColor(diagnosis.confidence)
            )}
          >
            {diagnosis.confidence}% match
          </span>
        </div>
        <CardDescription className="mt-2">{diagnosis.description}</CardDescription>
      </CardHeader>
          ...
          <AccordionItem value="more-info" className="border-b-0">
            ...
            <AccordionContent>
              <p className="text-sm text-muted-foreground pl-6">
                For more detailed information about {diagnosis.disease}, please consult with a healthcare professional. 
